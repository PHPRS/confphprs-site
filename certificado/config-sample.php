...
define('TITLE', 'PHPRS - Certificados');
define('EVENT_NAME', 'Eventos PHPRS');
define('CONTACT_LINK', 'http://phprs.com.br/');
...
define('DB_NAME', 'gera_certificado');
define('DB_USER', 'root');
define('DB_PASS', '');
...
define('IMG_NAME_TOP', 260);
define('IMG_NAME_SIZE', 30);

// /* Font and location of general description text. */
// define('IMG_DATA_FONT', BASE_PATH . '/font/arialbd.ttf');
// define('IMG_DATA_TOP', 310);
// define('IMG_DATA_SIZE', 20);

/* Font and location of description event. */
define('IMG_DESCRIPTION_FONT', BASE_PATH . '/font/arialbd.ttf');
define('IMG_DESCRIPTION_TOP', 310);
define('IMG_DESCRIPTION_SIZE', 20);

/* Font and location of title event. */
// define('IMG_TITLE_EVENT_FONT', BASE_PATH . '/font/arialbd.ttf');
// define('IMG_TITLE_EVENT_TOP', 140);
// define('IMG_TITLE_EVENT_SIZE', 40);
